import { ArrowRight, BaggageClaim, Briefcase, Check, Clock, IdCard, Mail, Phone } from 'lucide-react'
import calculateDurationInMonths from '../utils/calculateDurationInMonths'

const CertificateCard = ({ data }) => {
  console.log(data);
  const durationText = calculateDurationInMonths(data.startDate, data.endDate);
